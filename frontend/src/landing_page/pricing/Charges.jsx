    ...
    <>
      <div className="container p-5">
        <div className="row p-5 ">
          ...
          <div className="col-6 mt-4 charges">
            ...
            <p>
              When trading at Trade-X, STT/CTT can be a lot more than the
              brokerage we charge. <br />
            ...
            <p>
              ...
              W, T) at ₹375 per crore of turnover on flat rate <br />
            ...
            <p>
              ...
              dealer at Trade-X including <br /> auto square off orders.
            </p>
            <h6>Stamp charges</h6>
            <p>
          ...
          <div className="col-6 mt-4 charges">
            ...
            <p>
              ...
              brokerage <br />+ SEBI charges + transaction charges)
            </p>
            ...
            <p>
              ₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 Trade-X fee + ₹2.34 GST) is
              charged <br />
              on the trading account ledger when stocks are sold, irrespective
              of quantity.
            </p>
            <p>
            ...
            <p>
              ...
              (90 days). To learn <br />
              more about AMC, <a href="">Click here</a>
            </p>
